...
// PutSummary defines model for put-summary.
type PutSummary struct {
	// summary
	Summary *string `json:"summary,omitempty"`
}

// PutTag defines model for put-tag.
type PutTag struct {
	// tag
...
type PutTagJSONRequestBody PutTag

// LoginJSONRequestBody defines body for Login for application/json ContentType.
type LoginJSONRequestBody Authentication

// SignupJSONRequestBody defines body for Signup for application/json ContentType.
type SignupJSONRequestBody Authentication
...
type ServerInterface interface {
	...
	// user_idから複数のbook_idを取得。それぞれのbook_idから本の情報を取得
	// (GET /api/books)
